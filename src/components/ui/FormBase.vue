...
import InputLabels from '@/types/InputName'
...
<template>
  <div class="form-base">
    ...
    <p>This app calculates for you distance between two locations. Fill below inputs with the longitude and latitude in below form and click submit button to see the results.</p>
